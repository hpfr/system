...
* Installation
- [[https://nixos.org/nixos/download.html][Install NixOS]]
  - A simple configuration.nix from ~nixos-generate-config~ including git and
    internet access should be enough
- [[https://www.atlassian.com/git/tutorials/dotfiles][Install dotfiles as bare Git repo]]
- Symlink the desired host-specific Nix expression to the system-wide
